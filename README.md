...
> Пример тестирования модуля, который использует структуру Task, основанную на фабричном методе namedtuple. 
> Структура задачи используется в качестве структуры данных для передачи информации между пользовательским интерфейсом и API.
